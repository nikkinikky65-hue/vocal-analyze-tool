...
このスクリプトは **「自分の声の傾向を知る」ための個人向けツール** を想定しています。

- ✅ 自分の練習用録音を解析して、声のクセや変化を観察する  
- ✅ レッスンや自己分析の補助として使う  

一方で、次のような使い方は強く非推奨です。

- ❌ 他人の歌枠・歌ってみた動画などから勝手に音源を抽出し、  
      本人の許可なく評価・ランク付け・誹謗中傷に使うこと  
- ❌ 「この数値だからこの人はダメだ」といった、  
      人そのものの価値を決めつける用途  
- ❌ ツールの結果を根拠に、アンチ行為や攻撃的な言動を正当化すること  

この解析結果は **あくまで音響的な特徴の一部を数値化したもの** であり、  
歌の上手さ・魅力・表現力を決めるものではありません。

> 使う人の気持ちが前向きになる範囲で、  
> 「自分の方向性を知るヒント」として扱ってもらえると嬉しいです。
